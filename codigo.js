...
function trabajarWidget(data,idWidget) {
	...
	longTermDebtMRQ = longTermDebtMRQ = balanceSheetsQuarterly[nombreDeObjetos[0]]['longTermDebt'];
	longTermDebAtras = añoEspecifico(data,'Balance_Sheet', 'longTermDebt', 1);
	currentRatio =
		añoEspecifico(data,'Balance_Sheet', 'totalCurrentAssets', 0) /
		añoEspecifico(data,'Balance_Sheet', 'totalCurrentLiabilities', 0);
	currentRatioAtras =
	...
	currentLiabilitiesAtras = currentLiabilitiesAtras = añoEspecifico(data,'Balance_Sheet', 'otherCurrentLiab', 1);
	...
	// Grwoth
	numeroAños = maximo10Años(data,'Income_Statement', 'totalRevenue')[1];
	totalRevenuePasado = maximo10Años(data,'Income_Statement', 'totalRevenue')[0];
	totalRevenueG = CAGR(totalRevenueTTM, totalRevenuePasado, numeroAños);
	netIncomePasado = maximo10Años(data,'Income_Statement', 'netIncome')[0];
...
function maximo10Años(data,enDonde, cual) {

...
// // Modificar tooltip esteticamente
// display: true,
// yAlign: 'bottom',
// displayColors: false,
...
// // cambiarInfoAdentro
// callbacks: {
// 	// Definir valores en tooltip
// 	beforeBody: function(context) {
// 		lugarEnElQueEsta = context[0]['dataIndex']
// 		precioEnElQueEsta = context[1]['dataset']['data'][lugarEnElQueEsta]
// 		return `Price: ${arondir(precioEnElQueEsta)}`
// 	},
...
// 		lugarEnElQueEsta = context[0]['dataIndex']
// 		precioApertura = context[0]['dataset']['data'][0]
// 		precioEnElQueEsta = context[1]['dataset']['data'][lugarEnElQueEsta]
// 		cambioDesdeEntoncesPorcentual = `${masMenos(arondir((precioEnElQueEsta/precioApertura-1)*100))}%`
// 		cambioDesdeEntoncesNominal = `${masMenos(arondir(precioEnElQueEsta-precioApertura))}`
// 		return `Change: ${cambioDesdeEntoncesNominal}(${cambioDesdeEntoncesPorcentual})`
// 	},
// 	// Definir colores en tooltip
...
// }
		...
		// 		const bodyLines = tooltip.body[1]['lines']
		...
		// 			const textLabel = document.createTextNode(`Price: ${arondir(priceEnLugar)}`)
		// 			// append text label

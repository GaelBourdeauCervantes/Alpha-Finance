...
function trabajarWidget(data,idWidget) {
	...
	// Calcular Fscore
	roaTTM = netIncomeTTM /balanceSheetsQuarterly[nombreDeObjetos[0]]['totalAssets'];
	...
	assetsTurnOver = calcularTTM(data,'Income_Statement', 'totalRevenue')/ balanceSheetsQuarterly[nombreDeObjetos[0]]['totalAssets'] 
...
function Fscore(
	...
	if (numero(longTermDebt) < numero(totalDebtAtras)) {
		puntuacion = puntuacion + 1;
	}

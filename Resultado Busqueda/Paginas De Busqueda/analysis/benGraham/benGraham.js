...
function trabajarData(data) {
    ...
    guardarValorLocalStorage(ticker + ': Ben Graham intrinsic value: ', intrinsicValue)
...
function showResults(arrayPosibleResults) {
	...
	for(i = 0; i < repetir; i++) {
		...
		div.addEventListener('click', (event) => { 
			window.location.href = "../../analysis/benGraham/benGraham.html"
		})
		a.setAttribute('href','../../analysis/benGraham/benGraham.html')

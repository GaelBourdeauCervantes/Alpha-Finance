...
// Poner ticker a analyzar
tickerAnalyzarDocument = document.getElementById('tickerSymbolEmpresaAnalyzar')
tickerAnalyzarDocument.textContent = ticker
...
ratiosArray = trabajarDataGeneral('https://eodhistoricaldata.com/api/fundamentals/'+ ticker +'?api_token='+apiToken)
...
arrayTicketsParecidos = trabajarDataOtrasAccionesTickers('https://finnhub.io/api/v1/stock/peers?symbol='+ ticker +'&token=c32njgiad3ieculvq2ng')
...
function showResults(arrayPosibleResults) {
	...
	for(i = 0; i < repetir; i++) {
		...
		div.addEventListener('click', (event) => { 
			window.location.href = "../../analysis/earningsMultiples/earningsMultiples.html"
		})
		a.setAttribute('href','../../analysis/earningsMultiples/earningsMultiples.html')

...
function trabajarDataIndicadores(data) {
	...
	arrayAnualClose.then(arrayAnualClose => {
		...
		function hacerTTM(closePriceAperturaCitio){
			...
			graficaRatioMinimo('graficaQuickRatio', 'Quick Ratio', arrayQuickRatio, 1, labelsGrafica, '#21DE32')
			// Hacer Grafuca Coverage ratio
			graficaRatioMinimo('graficaCoverageRatio', 'Coverage Ratio', arrayCoverageRatio, 1.5, labelsGrafica, '#f5f51c')
		}

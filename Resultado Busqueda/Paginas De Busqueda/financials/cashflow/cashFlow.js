...
function showResults(arrayPosibleResults) {
	...
	for(i = 0; i < repetir; i++) {
		...
		div.addEventListener('click', (event) => { 
			window.location.href = "../../financials/cashflow/cashFlow.html"
		})
		a.setAttribute('href','../../financials/cashflow/cashFlow.html')
...
function checkScreenWidth() {
    ...
    depreciationAmortizationTitle = document.getElementById('depreciationAmortization');
    stockBasedCompensationTitle = document.getElementById('stockBasedCompensation')
    otherNonCashItemsTitle = document.getElementById('otherNonCashItems')
    changeReceivablesTitle = document.getElementById('changeReceivables')
    changeInventoryTitle = document.getElementById('changeInventory')
    changePayablesTitle = document.getElementById('changePayables')
    changeOtherCAssets = document.getElementById('changeOtherCAssets')
    changeOtherWorkCap = document.getElementById('changeOtherWorkCap')
    capexTitle = document.getElementById('capex')
    otherInvestingActivitesTitle = document.getElementById('otherInvestingActivites')
    issuancePaymentsOfDebtTitle = document.getElementById('issuancePaymentsOfDebt')
    salesPurchaseStocksTitle = document.getElementById('salesPurchaseStocks')
    otherFinancingTitle = document.getElementById('otherFinancing')

    // Check if the screen width is less than the threshold
    if (screenWidth < thresholdWidth) {
      // Change the text of the div
      depreciationAmortizationTitle.textContent = 'Dep&Amort'
      stockBasedCompensationTitle.textContent = 'Stock Compen'
      otherNonCashItemsTitle.textContent = 'Other Non Cash'
      changeReceivablesTitle.textContent = '+/- Receivables'
      changeInventoryTitle.textContent = '+/- Inventory'
      changePayablesTitle.textContent = '+/- Payables'
      changeOtherCAssets.textContent = '+/- Other C Assets'
      changeOtherWorkCap.textContent = '+/- Other W Cap'
      capexTitle.textContent = 'CapEx'
      otherInvestingActivitesTitle.textContent = 'Other Investings'
      issuancePaymentsOfDebtTitle.textContent = 'Payments of Debt'
      salesPurchaseStocksTitle.textContent = 'S/P stocks'
      otherFinancingTitle.textContent = 'Other Financings'
    } 
  }

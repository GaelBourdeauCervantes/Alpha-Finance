...
function trabajarData(data) {
	...
	coloresInstitutionHolders = [
		'#548C92',  // Azul Alpha principal
		'#7FB3B9',  // Azul claro suave
		'#B7D1D4',  // Gris azulado claro
		'#D6E5E7'   // Casi blanco con tinte azul
	];
	...
	coloresFundsHolders = [
		'#F4CE14',  // Amarillo Alpha (activo)
		'#C5A300',  // Dorado apagado
		'#E5E5E5',  // Gris claro neutro
		'#9EA0A1'   // Gris medio elegante
	];
	...
	hacerGraficaDona('graficaInsiderTransactionVentaVsCompra',['Buys','Sells'],[numeroCompras,numeroVentas],['#00A676','#D72638'],false)
	...
	hacerGraficaBarras('graficaInsiderTransaction',sortedNames,sortedAmounts,'#375E97	',true)
	// Obtener elementos---------------------------------------------------------------------------------------
	// Identidad
...
function showResults(arrayPosibleResults) {
	...
	for(i = 0; i < repetir; i++) {
		...
		div.addEventListener('click', (event) => { 
			window.location.href = "../owners/owners.html"
		})
		a.setAttribute('href','../owners/owners.html')

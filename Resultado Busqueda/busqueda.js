...
function trabajarData(data) {
	...
	totalAssetsMRQ = balanceSheetMRQ['totalAssets'];
	...
	// // Financial Strenght-----------------------
	totalRatioTTM = totalAssetsMRQ / totalLiabilitiesMRQ;
	...
	roaTTM = netIncomeTTM / totalAssetsMRQ
	...
	cfroaTTM = oparatingCashFlowTTM / totalAssetsMRQ
	totalDebAtras = añoEspecifico(data,'Balance_Sheet', 'shortLongTermDebtTotal', 1);
	...
	sharesOutstanndingAtrasAtras = añoEspecifico(data,'Balance_Sheet', 'commonStockSharesOutstanding', 1);
	grossMarginAtras = añoEspecifico(data,'Income_Statement', 'grossProfit', 1) / añoEspecifico(data,'Income_Statement', 'totalRevenue', 1);
	assetsTurnOverTTM = totalRevenueTTM / totalAssetsMRQ;
	assetsTurnOverAtras = añoEspecifico(data,'Income_Statement', 'totalRevenue', 1) / añoEspecifico(data,'Balance_Sheet', 'totalAssets', 1);
	fScore = Fscore(
		roaTTM,
		roaAtras,
		cfroaTTM,
	...
	debtToRevenueRatioMRQ = numero(balanceSheetMRQ['shortLongTermDebtTotal']) / totalRevenueTTM
	...
	financialstrength = financialstrengthRank(intrestCoverageRatioMRQ,intrestCoverageRatioMRQPasado,debtToRevenueRatioMRQ,zScore,totalRatioTTM,currentRatio)

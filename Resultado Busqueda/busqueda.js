...
// Paleta de colores: 
const colores = {
  azulOscuro: "#285260",    // rgb(40, 82, 96)
  azulMedio:  "#548C92",    // rgb(84, 140, 146)
  azulClaro:  "#B4D7D8",    // rgb(180, 215, 216)
  crema:      "#E0D7CF",    // rgb(224, 215, 207)
  arena:      "#AB9072",    // rgb(171, 144, 114)
  positivo:   "#188038",    // rgb(24, 128, 56)
  negativo:   "#d93025",    // rgb(217, 48, 37)
  neutro:     "#666666",    // rgb(102, 102, 102)
  textoGen:   "#1a1a1a",    // rgb(26, 26, 26)
  textoPrin:  "#2C3E50",    // rgb(44, 62, 80)
  textoSec:   "#BDC3C7",    // rgb(189, 195, 199)
  fondo:      "#f7f7f7"     // rgb(247, 247, 247)
};
...
function trabajarData(data) {
	...
	if(hayAnalystOpinion == 'si') {
		...
		grafaicaBarraAnaystas = hacerGraficaBarras('graficaBarras',labelsDegraficaAnalystas,dataDeGraficaAnalystas,['rgb(84, 140, 146)', 'rgb(122, 168, 117)', 'rgb(210, 190, 120)', 'rgb(192, 120, 84)', 'rgb(172, 88, 88)']
)
	}
	...
	hacerGraficaROIC('graficaROIC',arrayRoic,arrayGrwoth,años,2.5)
	// Hacer Tabla ROIC
	// Invertir arrays
	arrayRoic.reverse()
	arrayGrwoth.reverse()
	...
	lugar1yEstimation.innerHTML =`${arondir(wallStreetTargetPrice)}`
	// Valuation Rank Tabla
	...
	const externalToolTip = (context) => {
		...
		if(tooltip.body[1]) {
			...
			arrayPrecios.forEach((body,i) => {
				...
				// Cambiar color cambio
				tooltipEL.style.backgroundColor = colores['azulMedio']
			})
			...
			scales: {
				x: {
					ticks: {
						type: 'time',
						time: {
							unit: 'day', // importante para agrupar por día
							displayFormats: {
							day: 'd MMM' // ejemplo: 12 Jun
							}
						},
					},
					grid: {
			...
			datasets: [
				{
					...
					pointHoverRadius: 8,
					pointHoverBackgroundColor: '#fff',
					borderColor: 'rgb(84, 140, 146)', // Azul Alpha
					backgroundColor: 'rgba(84, 140, 146, 0.15)',
					tension: 0.5,
					borderWidth: anchoLinea,
				},
				{
					...
					pointHoverRadius: 8,
					pointHoverBackgroundColor: '#fff',
					borderColor: 'rgb(133, 180, 122)', // Verde pastel más claro
					backgroundColor: 'rgba(133, 180, 122, 0.15)',
					tension: 0.5,
					borderWidth: anchoLinea,
				},
			],
...
function hacerGraficaEarnings(
	...
	coloresPuntos = [];
	for (let i = 0; i < dataEarnigs.length - 1; i++) {
		if (dataEarnigs[i] > dataEstimate[i]) {
			coloresPuntos.push('rgb(122, 168, 117)'); // superó
		} else if (dataEarnigs[i] < dataEstimate[i]) {
			coloresPuntos.push('rgb(172, 88, 88)');   // no logró
		} else {
			coloresPuntos.push('rgb(120, 120, 120)'); // igualó
		}
	}
